...
public class Ac extends base {
	 ...
	 * 判断按钮是否被启用 id
	 */
	public static void isselect_id(String id) {
		driver.findElement(By.id(id)).isSelected();
	}

	/**
	 * 判断按钮是否被启用 ：true 为启用 id
	 */
	public boolean isselect_i(String id) {

		boolean a = driver.findElement(By.id(id)).isSelected();
		return a;
	}
	 ...
	 * 判断按钮是否被选择 name
	 */
	public static void isselect_name(String name) {
	 ...
	 * 
	 */
	public static void isselect_xpath(String xpath) {
	...
	public static void isDisplayed(String 注册) {
		driver.findElement(By.xpath(注册)).isDisplayed();
	}
